...
const Background = memo(({ children }: BackgroundProps) => {
  ...
  const excludeBackground = ["/account-settings"];

  const useCustomBackground = excludeBackground.includes(location.pathname);
  ...
  return useCustomBackground ? (
    ...
    <div className="relative flex-1 overflow-hidden bg-oxfordBlue">

      ...
      <div className="flex-1 overflow-y-auto">
        {queue.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full p-6 text-center text-gray-400">
            ...
            <p className="text-sm">Add songs to your queue by clicking the "Add to queue" button on any track.</p>
          </div>
        ) : (
                                  ...
                                  {isAuthenticated && (
                                    ...
                                    >
                                      <img
                                        ...
                                        className="w-4 h-4"
                                      />
                                      {isFavorited(track.id, track.provider) ? 'Remove from favorites' : 'Add to favorites'}
                                    </button>
                                  )}

...
const PlaylistDetailPage = () => {
    ...
    return (
        <div className="container mx-auto p-4 md:p-6 pb-24 text-textPrimary">
            ...
            <div className="flex flex-col md:flex-row md:items-end gap-6 mb-8">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-400 mb-4">
                        <span>{totalTrackCount} {totalTrackCount === 1 ? 'track' : 'tracks'}</span>
                        {playlist?.created_at && (
            ...
            <div className="mb-6 border-b border-gray-700">
                <div className="flex">
                    <button
                        ...
                        className={`py-2 px-4 ${activeProvider === 'all' ? 'border-b-2 border-accentPrimary text-white' : 'text-gray-400'}`}
                    >
                        All Sources
                    </button>
                    ...
                    {spotifyTrackCount > 0 && (
                        <button
                            ...
                            className={`py-2 px-4 flex items-center gap-2 ${activeProvider === 'spotify' ? 'border-b-2 border-accentPrimary text-white' : 'text-gray-400'}`}
                        >
                    ...
                    {soundcloudTrackCount > 0 && (
                        <button
                            ...
                            className={`py-2 px-4 flex items-center gap-2 ${activeProvider === 'soundcloud' ? 'border-b-2 border-accentPrimary text-white' : 'text-gray-400'}`}
                        >
            ...
            {/* SoundCloud section */}
            {(activeProvider === 'all' || activeProvider === 'soundcloud') && soundcloudTracks.length > 0 && (
                <div>
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center gap-2">
